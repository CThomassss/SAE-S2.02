...
image::Image/Logo_IUT_Blagnac.png[width=200]
...
* [x] Voici ci-dessous tous mes algorithmes réalisés durant la semaine :

[options="header"]
|==========================================================================
| #    | lien                                                     | langage  | catégorie 
| 1    | link:src/main/java/iut/sae/algo/Algo.java[Simplicité.java]   | Java     | Simplicité
| 2    | link:src/main/java/iut/sae/algo/Algo2.java[Efficacité.java]  | Java    | Efficacité
| ...  | link:src/main/java/iut/sae/algo/Algo3.java[Sobriété.java]     | Java      | Sobriété      
|==========================================================================
...
- Pour exécuter toutes mes classes, il suffit simplement de changer le nom de la classe ou du fichier, car ils sont tous deux différents à cause des consignes demandées.

=== Reproductibilité

. Installer les fichier Simplicité, Efficacité, Sobriété
. Ensuite faite les tests sur les fichiers 
